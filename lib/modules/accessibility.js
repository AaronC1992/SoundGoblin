...
export class KeyboardShortcuts {
    ...
    registerDefaults() {
        ...
        this.register('ctrl+l', () => {
            window.dispatchEvent(new CustomEvent('soundgoblin:toggle-listening'));
        }, 'Toggle listening on/off');
        
        // Audio controls
        this.register('ctrl+m', () => {
            window.dispatchEvent(new CustomEvent('soundgoblin:toggle-music'));
        }, 'Mute/unmute music');
        
        this.register('ctrl+s', () => {
            window.dispatchEvent(new CustomEvent('soundgoblin:stop-all'));
        }, 'Stop all sounds');
        
        this.register('ctrl+shift+s', () => {
            window.dispatchEvent(new CustomEvent('soundgoblin:toggle-sfx'));
        }, 'Mute/unmute sound effects');
        
        // Volume controls
        this.register('ctrl+arrowup', () => {
            window.dispatchEvent(new CustomEvent('soundgoblin:volume-up'));
        }, 'Increase volume');
        
        this.register('ctrl+arrowdown', () => {
            window.dispatchEvent(new CustomEvent('soundgoblin:volume-down'));
        }, 'Decrease volume');
        ...
        this.register('escape', () => {
            this.hideHelp();
            window.dispatchEvent(new CustomEvent('soundgoblin:close-modal'));
        }, 'Close modal/help');
    }
