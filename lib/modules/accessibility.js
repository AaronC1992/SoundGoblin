...
export class KeyboardShortcuts {
    ...
    registerDefaults() {
        ...
        this.register('ctrl+l', () => {
            window.dispatchEvent(new CustomEvent('Immersify:toggle-listening'));
        }, 'Toggle listening on/off');
        
        // Audio controls
        this.register('ctrl+m', () => {
            window.dispatchEvent(new CustomEvent('Immersify:toggle-music'));
        }, 'Mute/unmute music');
        
        this.register('ctrl+s', () => {
            window.dispatchEvent(new CustomEvent('Immersify:stop-all'));
        }, 'Stop all sounds');
        
        this.register('ctrl+shift+s', () => {
            window.dispatchEvent(new CustomEvent('Immersify:toggle-sfx'));
        }, 'Mute/unmute sound effects');
        
        // Volume controls
        this.register('ctrl+arrowup', () => {
            window.dispatchEvent(new CustomEvent('Immersify:volume-up'));
        }, 'Increase volume');
        
        this.register('ctrl+arrowdown', () => {
            window.dispatchEvent(new CustomEvent('Immersify:volume-down'));
        }, 'Decrease volume');
        ...
        this.register('escape', () => {
            this.hideHelp();
            window.dispatchEvent(new CustomEvent('Immersify:close-modal'));
        }, 'Close modal/help');
    }
