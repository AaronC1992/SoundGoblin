// ===== Immersify - CENTRALIZED CONFIGURATION =====
...
if (typeof window !== 'undefined') {
    window.Immersify_CONFIG = CONFIG;
    window.Immersify_getConfig = getConfig;
    if (isDevelopment()) {
        window.Immersify_setConfig = setConfig;
    }
}
