// ===== SoundGoblin - CENTRALIZED CONFIGURATION =====
...
export const CONFIG = {
    ...
    // ===== FEATURE FLAGS =====
    FEATURES: {
        ENABLE_DEEPGRAM: false, // Discontinued
        ENABLE_CHROMA: false, // Discontinued
...
if (typeof window !== 'undefined') {
    window.SoundGoblin_CONFIG = CONFIG;
    window.SoundGoblin_getConfig = getConfig;
    if (isDevelopment()) {
        window.SoundGoblin_setConfig = setConfig;
    }
}
